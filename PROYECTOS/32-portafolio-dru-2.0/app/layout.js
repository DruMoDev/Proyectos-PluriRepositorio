...
export const metadata = {
  ...
  icons: {
    icon: "https://res.cloudinary.com/dpjbtovxz/image/upload/v1715592711/Portafolio/favicon-32x32_jo6fhm.png",
    shortcut: "https://res.cloudinary.com/dpjbtovxz/image/upload/v1715592711/Portafolio/favicon-32x32_jo6fhm.png",
    apple: "https://res.cloudinary.com/dpjbtovxz/image/upload/v1715592711/Portafolio/favicon-32x32_jo6fhm.png",
    other: {
...
export default function RootLayout({ children }) {
  return (
    ...
    >
      <head>
        <link rel="shortcut icon" href="https://res.cloudinary.com/dpjbtovxz/image/upload/v1715592711/Portafolio/favicon-32x32_jo6fhm.png" />
      </head>
