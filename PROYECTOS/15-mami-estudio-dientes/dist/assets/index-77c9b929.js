 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lF(t){uF(t,(e,n)=>new Dk(e,n,new iF)),t.registerVersion(tF,nF)}lF(on);const cF=()=>{const t=()=>{const e=new on.auth.GoogleAuthProvider;on.auth().signInWithPopup(e)};return G.jsx("button",{className:"border text-lg font-semibold  bg-blue-200 p-3 px-8 m-4 rounded-lg",onClick:t,children:"Sign In with Google"})};var Lk={color:void 0,size:void 0,className:void 0,style:void 0,attr:void 0},V0=yr.createContext&&yr.createContext(Lk),Nr=globalThis&&globalThis.__assign||function(){return Nr=Object.assign||function(t){for(var e,n=1,r=arguments.length;n<r;n++){e=arguments[n];for(var i in e)Object.prototype.hasOwnProperty.call(e,i)&&(t[i]=e[i])}return t},Nr.apply(this,arguments)},hF=globalThis&&globalThis.__rest||function(t,e){var n={};for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&e.indexOf(r)<0&&(n[r]=t[r]);if(t!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,r=Object.getOwnPropertySymbols(t);i<r.length;i++)e.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(t,r[i])&&(n[r[i]]=t[r[i]]);return n};function Mk(t){return t&&t.map(function(e,n){return yr.createElement(e.tag,Nr({key:n},e.attr),Mk(e.child))})}function $k(t){return function(e){return yr.createElement(dF,Nr({attr:Nr({},t.attr)},e),Mk(t.child))}}function dF(t){var e=function(n){var r=t.attr,i=t.size,s=t.title,o=hF(t,["attr","size","title"]),a=i||n.size||"1em",u;return n.className&&(u=n.className),t.className&&(u=(u?u+" ":"")+t.className),yr.createElement("svg",Nr({stroke:"currentColor",fill:"currentColor",strokeWidth:"0"},n.attr,r,o,{className:u,style:Nr(Nr({color:t.color||n.color},n.style),t.style),height:a,width:a,xmlns:"http://www.w3.org/2000/svg"}),s&&yr.createElement("title",null,s),t.children)};return V0!==void 0?yr.createElement(V0.Consumer,null,function(n){return e(n)}):e(Lk)}function fF(t){return $k({tag:"svg",attr:{viewBox:"0 0 24 24"},child:[{tag:"g",attr:{},child:[{tag:"path",attr:{fill:"none",d:"M0 0h24v24H0z"}},{tag:"path",attr:{d:"M12 10.586l4.95-4.95 1.414 1.414-4.95 4.95 4.95 4.95-1.414 1.414-4.95-4.95-4.95 4.95-1.414-1.414 4.95-4.95-4.95-4.95L7.05 5.636z"}}]}]})(t)}function pF(t){return $k({tag:"svg",attr:{viewBox:"0 0 24 24"},child:[{tag:"g",attr:{},child:[{tag:"path",attr:{fill:"none",d:"M0 0h24v24H0z"}},{tag:"path",attr:{d:"M3 4h18v2H3V4zm6 7h12v2H9v-2zm-6 7h18v2H3v-2z"}}]}]})(t)}const mF=()=>{const[t,e]=hn.useState(!1),n=()=>{e(!t)};return G.jsx("nav",{className:"bg-gray-800",children:G.jsxs("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",children:[G.jsxs("div",{className:"flex items-center justify-between h-16",children:[G.jsx("div",{className:"flex-shrink-0",children:G.jsx("span",{className:"h-8 w-8 text-white",children:"Nuria Casals"})}),G.jsx("div",{className:"md:hidden",children:G.jsx("button",{onClick:n,className:"text-gray-300 hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium text-xl",children:t?G.jsx(fF,{}):G.jsx(pF,{})})}),G.jsx("div",{className:"hidden md:block",children:G.jsxs("div",{className:"ml-10 flex items-baseline space-x-4",children:[G.jsx("a",{href:"#",className:"text-gray-300 hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium",children:"Inicio"}),G.jsx("a",{href:"#",className:"text-gray-300 hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium",children:"Acerca de"}),G.jsx("a",{href:"#",className:"text-gray-300 hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium",children:"Servicios"}),G.jsx("a",{href:"#",className:"text-gray-300 hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium",children:"Contacto"})]})})]}),t&&G.jsx("div",{className:"md:hidden flex items-center justify-center",children:G.jsxs("div",{className:"px-2 pt-2 pb-3 space-y-1 sm:px-3",children:[G.jsx("a",{href:"#",className:"text-gray-300 hover:bg-gray-700 block px-3 py-2 rounded-md text-base font-medium",children:"Inicio"}),G.jsx("a",{href:"#",className:"text-gray-300 hover:bg-gray-700 block px-3 py-2 rounded-md text-base font-medium",children:"Acerca de"}),G.jsx("a",{href:"#",className:"text-gray-300 hover:bg-gray-700 block px-3 py-2 rounded-md text-base font-medium",children:"Servicios"}),G.jsx("a",{href:"#",className:"text-gray-300 hover:bg-gray-700 block px-3 py-2 rounded-md text-base font-medium",children:"Contacto"})]})})]})})},gF=()=>{const t=()=>{on.auth().signOut()};return G.jsx("button",{className:"border text-lg font-semibold  bg-blue-200 p-3 px-8 m-4 rounded-lg",onClick:t,children:"Sign Out"})};function yF({user:t}){return G.jsxs("div",{className:"h-full flex flex-col justify-center items-center",children:[G.jsxs("h1",{className:"text-xl m-4 font-semibold",children:["Bienvenido ",t.displayName,"!"]}),G.jsx("h3",{children:"Te has lavado los dientes?"}),G.jsx("div",{className:"absolute top-16 right-0",children:G.jsx(gF,{})})]})}const vF={apiKey:"AIzaSyABIBkupqUd2C-jr3eEzoTAuuZtIoNWnQU",authDomain:"nuria-casals-estudio-dientes.firebaseapp.com",projectId:"nuria-casals-estudio-dientes",storageBucket:"nuria-casals-estudio-dientes.appspot.com",messagingSenderId:"930987286988",appId:"1:930987286988:web:2e2de06bc6e3a9befe7d69"};on.initializeApp(vF);on.firestore();function wF(){const[t]=JP(on.auth());return G.jsxs("div",{className:"w-screen",children:[G.jsx(mF,{}),G.jsx("section",{className:"h-screen",children:t?G.jsx(yF,{user:t}):G.jsxs("div",{className:"h-screen flex flex-col justify-center items-center",children:[G.jsx("h1",{className:"md:text-2xl text-lg m-4 font-semibold",children:"¡Bienvenido al estudio de Nuria Casals!"}),G.jsx("p",{children:"Inicia sesión para registrar tu progreso!"}),G.jsx(cF,{})]})})]})}nf.createRoot(document.getElementById("root")).render(G.jsx(yr.StrictMode,{children:G.jsx(wF,{})}));
